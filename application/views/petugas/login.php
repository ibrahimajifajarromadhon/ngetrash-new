    ...
    <div class="login_wrapper">
      <section class="login_content">
        <form action="<?php echo site_url('petugas/login_aksi'); ?>" method="post">
          <h1 style="font-size:1.7em; font-family:Poppins, sans-serif;"><b>Login Petugas</b></h1>
          ...
          <div class="separator">
            <p class="change_link">New to site?
              <a href="<?php echo site_url('petugas/register'); ?>" class="text-center" style="font-size:0.88em; font-family:Poppins, sans-serif;"><b>Register Account</b></a>
            </p>
