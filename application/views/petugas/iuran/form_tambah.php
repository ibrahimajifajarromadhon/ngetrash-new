                                    ...
                                    <div class="col-lg-7 mb-5">
                                        <div class="contact-form">
                                            ...
                                            <form name="sentMessage" method="post" action="<?php echo site_url('petugas_iuran/save'); ?>" enctype="multipart/form-data">
                                                ...
                                                <?php if ($this->session->flashdata('error_paketBayar')) : ?>
                                                    <div class="pb-0 pt-3 alert alert-danger alert-dismissible text-whitesmoke">
                                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                                ...
                                                <div class="control-group mb-3">
                                                    ...
                                                    <select class="form-control" name="paketBayar">
                                                        ...
                                                        <option value="2" <?= ($this->session->flashdata('input_paketBayar') == '2') ? 'selected' : ''; ?>>1 Bulan</option>
                                                        <option value="3" <?= ($this->session->flashdata('input_paketBayar') == '3') ? 'selected' : ''; ?>>1 Tahun</option>
                                                    </select>
                                                </div>
