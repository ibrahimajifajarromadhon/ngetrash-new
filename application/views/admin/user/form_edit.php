                                ...
                                <div class="row px-xl-3 pt-3">
                                    <div class="col-lg-7 mb-5">
                                        <div class="contact-form">
                                            <form name="sentMessage" method="post" action="<?php echo site_url('admin_user/edit'); ?>">
                                                ...
                                                <div class="control-group mb-3 mx-1">
                                                    ...
                                                    <input id="name" name="name" class="form-control" value="<?php echo $user->name; ?>">
                                                    <p class="help-block text-danger"></p>
                                                </div>
                                                <div class="control-group mb-3 mx-1">
                                                    <label id="userName" class="font-weight-bold">Username</label>
                                                    <input type="email" name="userName" class="form-control" value="<?php echo $user->userName; ?>">
                                                </div>
                                                <div class="control-group mb-3 mx-1">
                                                ...
                                                <div class="control-group mb-3 mx-1">
                                                    ...
                                                    <select class="form-control" name="statusAktif">
                                                        ...
                                                        <option value="Y" <?= ($user->statusAktif == 'Y') ? 'selected' : '' ?>>Aktif</option>
                                                        <option value="N" <?= ($user->statusAktif == 'N') ? 'selected' : '' ?>>Tidak Aktif</option>
                                                    </select>
                                                </div>
